...
export const translations = {
    en: {
        ...
        upload_page: {
            ...
            free_ticket_desc: "Added to the viewer's library before playback.",
        ...
        watch_page: {
            ...
            free_access_ready: "Free access ready",
        ...
        landing: {
            ...
            use_cases: {
                ...
                concerts_digital: "With YouTick: Sell your concert recordings as digital tickets. Fans pay once and keep access while the encrypted media remains available. You earn 98% from every sale.",
            ...
            value_proposition: {
                ...
                description: "No monthly fees. No revenue sharing schemes. Publish once and keep earning from your catalog while it remains available—and you keep almost all of it.",
            ...
            value_proposition_section: {
                ...
                tech_note: "Behind the scenes, digital tickets protect access, media is encrypted before delivery, and serverless edge components help run playback without a traditional media server."
            },
        ...
        financial_chart: {
            ...
            subtitle: "Traditional release paths can reduce creator revenue. YouTick keeps the ticket split simple for film and music releases.",
            ...
            summary_subtitle: "2% platform fee, 98% creator revenue"
        }
    },
    tr: {
        nav: {
        ...
        upload_page: {
            ...
            free_ticket_desc: "İzlemek için kütüphaneye eklenir.",
        ...
        watch_page: {
            ...
            free_access_ready: "Ücretsiz erişim hazır",
        ...
        landing: {
            ...
            use_cases: {
                ...
                concerts_digital: "YouTick ile: Konser kayıtlarını dijital bilet olarak sat. Hayranlar bir kez öder ve medya erişilebilir kaldığı sürece erişimini korur. Her satıştan %98 sana.",
            ...
            value_proposition: {
                ...
                subtitle: "Sana Kalır",
                description: "Aylık ücret yok. Gelir paylaşım planları yok. Eserini yayına al ve katalog erişilebilir kaldıkça gelir elde et—ve neredeyse tamamı senin.",
            ...
            value_proposition_section: {
                ...
                tech_note: "Arka planda dijital bilet erişimi korur, medya teslimattan önce şifrelenir ve serverless edge bileşenleri geleneksel medya sunucusu olmadan oynatmaya yardımcı olur."
            },
            roi_calculator_section: {
        ...
        financial_chart: {
            ...
            subtitle: "Geleneksel yayın yolları yaratıcı gelirini azaltabilir. YouTick film ve müzik yayınlarında bilet paylaşımını sade tutar.",
            ...
            summary_subtitle: "%2 platform ücreti, %98 yaratıcı geliri"
        }
    }
};
