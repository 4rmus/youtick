    ...
    return (
        <div className="fixed bottom-6 left-6 z-50">
            <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-zinc-900/90 backdrop-blur-sm border border-zinc-800 rounded-lg hover:border-near-green/50 transition-all group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-near-green"
