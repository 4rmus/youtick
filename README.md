...
Deployed to: `v1-0-0.utick.testnet`
...
near view v1-0-0.utick.testnet nft_metadata '{}'

# List tokens
near view v1-0-0.utick.testnet nft_tokens '{"from_index":"0","limit":10}'

# Get event details
near view v1-0-0.utick.testnet get_event '{"encrypted_cid":"VIDEO_CID"}'
```
...
**Contract**: `v1-0-0.utick.testnet` | **Version**: 1.0.0 MVP
